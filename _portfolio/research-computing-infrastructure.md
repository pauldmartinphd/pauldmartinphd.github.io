...
<figure style="margin: 20px 0;">
  <img src="/images/homelab-rack.jpg" alt="Server rack with virtualization host, hot-swap drive bays, and CyberPower UPS" style="max-height: 480px; border-radius: 4px;" />
...
<figure style="margin: 20px 0;">
  <img src="/images/server-build-interior.jpg" alt="Server chassis interior showing Noctua CPU cooler, Corsair RM850x power supply, Intel Arc Pro GPU, and dual hot-swap drive cages with routed SATA cabling" style="max-height: 480px; border-radius: 4px;" />
