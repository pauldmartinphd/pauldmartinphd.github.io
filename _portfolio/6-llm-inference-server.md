...
A single-chassis system designed to run frontier-class large language models — including MiniMax M3, GLM-5.2, and Kimi K2.6 — at interactive speeds without cloud API dependency.
