...
*Wi-Fi (WPA/WPA2) authentication and network access control.*
Services: Section 101 validity analysis, expert declaration drafting.
...
PGR2025-00041
*Cloud-based vehicle management and security systems.*
...
IPR2025-00100
*Security processors embedded in microprocessors.*
Services: Invalidity analysis, IPR drafting.
...
*Timeline of software development and misappropriation of trade secrets.*
...
*Patents on secure erase processes.*
...
*Patents on wireless network handoff, network management, and authentication technologies.*
...
*Patents on image detection algorithms.*
...
*Videoconferencing and network performance optimization.*
...
*Patents on probability systems.*
...
*Patents on electronic ticketing.*
...
*Patents on map overlays and messaging systems.*
Services: Source code review.
...
*Patents on telephony management systems and skill-based matchmaking.*
...
*Defamation and voting machine security.*
...
*Patents on network monitoring devices and security gateways.*
...
*Patents on user-adapted video streams.*
...
*Software development practices and breach of contract.*
Services: Document review, source code review, report drafting.

**Blackberry Limited v. Facebook, Inc.**
Case No. 2:18-cv-01844-KSx
*Patents on agent-based network monitoring, configuration, and security systems.*
...
Case No. 1:18-cv-826-WCB
*Patents on payment processing systems.*
Services: Source code review, documentation review, validity analysis, infringement analysis, report drafting.
...
*Patents on authentication technologies.*
...
*Patents on security gateways, URL filtering, and categorization.*
...
*Device performance and service outages.*
...
Inv. No. 337-TA-1049
*Patents on television streaming devices and/or services.*
...
*Patents on virtualization and automated corruption repair.*
Services: Prior art search, invalidity argument strategy, non-infringement argument strategy, source code reviews.

**Finjan v. Symantec Corporation**
Case No. 14-cv-02998-HSG
*Patents on malware scanning gateways, endpoint protection, and firewalls.*
...
*Patents on hardware accelerated cryptographic processors.*
Services: Infringement analysis, validity analysis, source code review, report drafting.
...
*Patents on vulnerability scanning.*
...
*Patents on browser sandboxing and process isolation.*
...
*Patents on static debugging tools.*
...
[&larr; Back to Expert Witness overview](/expert-witness/)
